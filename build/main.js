...
class AreaFloorRoomHandler extends utils.Adapter {
    constructor(options = {}) {
        super(Object.assign(Object.assign({}, options), { name: 'area-floor-room-handler' }));
...
if (module.parent) {
    ...
    module.exports = (options) => new AreaFloorRoomHandler(options);
}
else {
    // otherwise start the instance directly
    (() => new AreaFloorRoomHandler())();
}
